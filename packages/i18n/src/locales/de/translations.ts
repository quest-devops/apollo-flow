...
export default {
  ...
  contact_sales: "Support kontaktieren",
  ...
  support: "Support",
  forum: "Forum",
  powered_by_plane_pages: "Bereitgestellt von Apollo Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "Die meisten Dinge beginnen mit einem Projekt in Apollo.",
        cta: "Los geht’s",
      },
      invite_team: {
        title: "Team einladen",
      ...
      personalize_account: {
        title: "Personalisieren Sie Apollo.",
  ...
  workspace_creation: {
    ...
    subheading: "Um Apollo verwenden zu können, müssen Sie einen Arbeitsbereich erstellen oder beitreten.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Willkommen bei Apollo, wir freuen uns, dass Sie hier sind. Erstellen Sie Ihr erstes Projekt, verfolgen Sie Arbeitselemente und diese Seite verwandelt sich in einen Ort für Ihren Fortschritt. Administratoren sehen hier zusätzlich teamrelevante Elemente.",
        primary_button: {
          text: "Erstes Projekt erstellen",
          comic: {
            title: "Alles beginnt mit einem Projekt in Apollo",
            description:
  ...
  workspace_settings: {
    ...
    copy_key:
      "Kopieren Sie diesen Schlüssel und fügen Sie ihn in Apollo Pages ein. Nach dem Schließen können Sie ihn nicht mehr sehen. Eine CSV-Datei mit dem Schlüssel wurde heruntergeladen.",
    ...
    empty_state: {
      api_tokens: {
        ...
        description: "Verwenden Sie die API, um Apollo mit externen Systemen zu integrieren.",
      },
      webhooks: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Apollo wird Arbeitselemente automatisch archivieren, die abgeschlossen oder abgebrochen wurden.",
        duration: "Arbeitselemente automatisch archivieren, die seit",
      },
      "auto-close": {
        title: "Arbeitselemente automatisch schließen",
        description:
          "Apollo wird Arbeitselemente automatisch schließen, die nicht abgeschlossen oder abgebrochen wurden.",
  ...
  project_page: {
    empty_state: {
      general: {
        title: "Notieren Sie Ideen, Dokumente oder Wissensdatenbanken. Nutzen Sie Apollo AI.",
        description:
  ...
  self_hosted_maintenance_message: {
    plane_didnt_start_up_this_could_be_because_one_or_more_plane_services_failed_to_start:
      "Apollo ist nicht gestartet. Dies könnte daran liegen, dass einer oder mehrere Apollo-Services nicht starten konnten.",
