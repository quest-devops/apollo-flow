...
export default {
  ...
  auth: {
    common: {
      ...
      new_to_plane: "Nouveau sur Apollo ?",
  ...
  support: "Support",
  forum: "Forum",
  powered_by_plane_pages: "Propulsé par Apollo Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "La plupart des choses commencent par un projet dans Apollo.",
        cta: "Commencer",
      },
      invite_team: {
      ...
      personalize_account: {
        title: "Faites d’Apollo le vôtre.",
  ...
  workspace_creation: {
    ...
    subheading: "Pour commencer à utiliser Apollo, vous devez créer ou rejoindre un espace de travail.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Bienvenue sur Apollo, nous sommes ravis de vous avoir parmi nous. Créez votre premier projet et suivez vos éléments de travail, et cette page se transformera en un espace qui vous aide à progresser. Les administrateurs verront également les éléments qui aident leur équipe à progresser.",
        primary_button: {
          text: "Construisez votre premier projet",
          comic: {
            title: "Tout commence par un projet dans Apollo",
            description:
  ...
  workspace_settings: {
    ...
    copy_key:
      "Copiez et sauvegardez cette clé secrète dans Apollo Pages. Vous ne pourrez plus voir cette clé après avoir cliqué sur Fermer. Un fichier CSV contenant la clé a été téléchargé.",
    ...
    settings: {
      ...
      api_tokens: {
        ...
        delete: {
          ...
          description:
            "Toute application utilisant ce jeton n’aura plus accès aux données d’Apollo. Cette action ne peut pas être annulée.",
          success: {
            title: "Succès !",
    ...
    empty_state: {
      api_tokens: {
        ...
        description:
          "Les API Apollo peuvent être utilisées pour intégrer vos données dans Apollo avec n’importe quel système externe. Créez un jeton pour commencer.",
      },
      webhooks: {
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        ...
        description:
          "Commencez par créer un nouvel élément de travail ! Ajoutez-y des détails et des propriétés. Explorez davantage Apollo pour voir votre activité.",
      },
      assigned: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Apollo archivera automatiquement les éléments de travail qui ont été complétés ou annulés.",
      ...
      "auto-close": {
        ...
        description: "Apollo fermera automatiquement les éléments de travail qui n’ont pas été complétés ou annulés.",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          ...
          comic: {
            title: "Les éléments de travail sont les blocs de construction dans Apollo.",
            description:
              "Refondre l’interface d’Apollo, Renouveler l’image de marque de l’entreprise, ou Lancer le nouveau système d’injection de carburant sont des exemples d’éléments de travail qui ont probablement des sous-éléments.",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        title:
          "Rédigez une note, un document ou une base de connaissances complète. Obtenez l’aide d’Apollo AI pour commencer",
        description:
          "Les Pages sont un espace de réflexion dans Apollo. Prenez des notes de réunion, formatez-les facilement, intégrez des éléments de travail, disposez-les à l’aide d’une bibliothèque de composants, et gardez-les tous dans le contexte de votre projet. Pour faciliter la rédaction de tout document, faites appel à Apollo AI avec un raccourci ou un clic sur un bouton.",
        primary_button: {
  ...
  self_hosted_maintenance_message: {
    plane_didnt_start_up_this_could_be_because_one_or_more_plane_services_failed_to_start:
      "Apollo n’a pas démarré. Cela pourrait être dû au fait qu’un ou plusieurs services Apollo ont échoué à démarrer.",
