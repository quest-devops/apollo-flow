...
export default {
  ...
  auth: {
    common: {
      ...
      new_to_plane: "Apollo'ya yeni mi geldiniz?",
  ...
  support: "Destek",
  forum: "Forum",
  powered_by_plane_pages: "Apollo Pages tarafından desteklenmektedir",
  ...
  home: {
    empty: {
      ...
      create_project: {
        title: "Proje oluştur",
        description: "Çoğu şey Apollo'da bir projeyle başlar.",
        cta: "Başla",
      },
      invite_team: {
      ...
      personalize_account: {
        title: "Apollo'yu kendinize özelleştirin.",
  ...
  workspace_creation: {
    ...
    subheading: "Apollo'yu kullanmaya başlamak için bir çalışma alanı oluşturmalı veya katılmalısınız.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Apollo'ya hoş geldiniz, sizi aramızda görmekten heyecan duyuyoruz. İlk projenizi oluşturun ve iş öğelerinizi takip edin, bu sayfa ilerlemenize yardımcı olacak bir alana dönüşecek. Yöneticiler ayrıca ekiplerinin ilerlemesine yardımcı olacak öğeler görecek.",
        primary_button: {
          text: "İlk projenizi oluşturun",
          comic: {
            title: "Apollo'da her şey bir projeyle başlar",
            description:
  ...
  workspace_settings: {
    ...
    copy_key:
      "Bu gizli anahtarı Apollo Pages'e kopyalayıp kaydedin. Kapat düğmesine bastıktan sonra bu anahtarı göremezsiniz. Anahtar içeren bir CSV dosyası indirildi.",
    ...
    settings: {
      ...
      api_tokens: {
        ...
        delete: {
          ...
          description: "Bu token'ı kullanan uygulamalar artık Apollo verilerine erişemeyecek. Bu işlem geri alınamaz.",
          success: {
            title: "Başarılı!",
    ...
    empty_state: {
      api_tokens: {
        ...
        description: "Apollo API'lerini harici sistemlere entegre etmek için bir token oluşturun.",
      },
      webhooks: {
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        ...
        description:
          "Yeni bir iş öğesi oluşturarak başlayın! Detaylar ve özellikler ekleyin. Aktivitenizi görmek için Apollo'da daha fazlasını keşfedin.",
      },
      assigned: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Apollo, tamamlanan veya iptal edilen iş öğelerini otomatik arşivleyecek.",
        duration: "Şu süre kapalı kalan iş öğelerini otomatik arşivle",
      },
      "auto-close": {
        title: "İş öğelerini otomatik kapat",
        description: "Apollo, tamamlanmamış veya iptal edilmemiş iş öğelerini otomatik kapatacak.",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          ...
          comic: {
            title: "İş öğeleri Apollo'da yapı taşlarıdır.",
            description:
              "Apollo UI'yi yeniden tasarlamak, şirketi yeniden markalaştırmak veya yeni yakıt enjeksiyon sistemini başlatmak, muhtemelen alt iş öğeleri olan iş öğesi örnekleridir.",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        title:
          "Bir not, belge veya tam bir bilgi bankası yazın. Apollo AI'nın başlamanıza yardımcı olmasını sağlayın",
        description:
          "Sayfalar Apollo'da düşüncelerinizi döktüğünüz alanlardır. Toplantı notları alın, kolayca biçimlendirin, iş öğelerini yerleştirin, bir bileşen kitaplığı kullanarak düzenleyin ve hepsini proje bağlamınızda tutun. Herhangi bir belgeyi hızlıca tamamlamak için bir kısayol veya düğme ile Apollo AI'yı çağırın.",
        primary_button: {
  ...
  self_hosted_maintenance_message: {
    plane_didnt_start_up_this_could_be_because_one_or_more_plane_services_failed_to_start:
      "Apollo başlatılamadı. Bu, bir veya daha fazla Apollo servisinin başlatılamaması nedeniyle olabilir.",
