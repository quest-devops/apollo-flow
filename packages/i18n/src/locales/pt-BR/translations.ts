...
export default {
  ...
  contact_sales: "Contatar suporte",
  ...
  support: "Suporte",
  forum: "Forum",
  powered_by_plane_pages: "Desenvolvido por Apollo Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "A maioria das coisas começa com um projeto no Apollo.",
        cta: "Começar",
      },
      invite_team: {
  ...
  workspace_creation: {
    ...
    subheading: "Para começar a usar o Apollo, você precisa criar ou entrar em um espaço de trabalho.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Bem-vindo ao Apollo, estamos animados por tê-lo aqui. Crie seu primeiro projeto e rastreie seus itens de trabalho, e esta página se transformará em um espaço que ajuda você a progredir. Os administradores também verão itens que ajudam sua equipe a progredir.",
        primary_button: {
          text: "Construa seu primeiro projeto",
          comic: {
            title: "Tudo começa com um projeto no Apollo",
            description:
  ...
  account_settings: {
    ...
    preferences: {
      ...
      description: "Personalize a experiência do app do seu jeito",
    },
    notifications: {
      heading: "Notificações por e-mail",
      description: "Fique por dentro dos itens que você acompanha. Ative para ser notificado.",
    },
    security: {
      heading: "Segurança",
    },
    api_tokens: {
      ...
      description: "Gere tokens de API seguros para integrar seus dados com sistemas e aplicações externos.",
    },
    activity: {
      heading: "Atividade",
      description: "Acompanhe suas ações e mudanças recentes em todos os projetos e itens.",
    },
  },
  workspace_settings: {
    ...
    copy_key:
      "Copie e salve esta chave secreta no Páginas do Apollo. Você não pode ver esta chave depois de clicar em Fechar. Um arquivo CSV contendo a chave foi baixado.",
    ...
    settings: {
      ...
      billing_and_plans: {
        ...
        heading: "Faturamento e planos",
        description: "Escolha seu plano, gerencie assinaturas e faça upgrade conforme a necessidade.",
      },
      exports: {
        title: "Exportações",
        ...
        heading: "Exportações",
        description:
          "Exporte os dados dos seus projetos em vários formatos e acesse o histórico com links de download.",
        exporting_projects: "Exportando projeto",
        format: "Formato",
      },
      webhooks: {
        title: "Webhooks",
        ...
        heading: "Webhooks",
        description: "Automatize notificações para serviços externos quando eventos do projeto acontecerem.",
      },
      api_tokens: {
        title: "Tokens de API",
        ...
        delete: {
          ...
          description:
            "Qualquer aplicativo que use este token não terá mais acesso aos dados do Apollo. Esta ação não pode ser desfeita.",
          success: {
            title: "Sucesso!",
    ...
    empty_state: {
      api_tokens: {
        ...
        description:
          "As APIs do Apollo podem ser usadas para integrar seus dados no Apollo com qualquer sistema externo. Crie um token para começar.",
      },
      webhooks: {
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        ...
        description:
          "Comece criando um novo item de trabalho! Adicione detalhes e propriedades a ele. Explore mais no Apollo para ver sua atividade.",
      },
      assigned: {
  ...
  project_settings: {
    ...
    labels: {
      ...
      heading: "Etiquetas",
      description: "Crie etiquetas personalizadas para categorizar e organizar seus itens",
    },
    estimates: {
      label: "Estimativas",
      ...
      heading: "Estimativas",
      enable_description: "Elas ajudam a comunicar a complexidade e a carga de trabalho do time.",
    },
    automations: {
      label: "Automações",
      "auto-archive": {
        title: "Arquivar automaticamente itens de trabalho fechados",
        description: "O Apollo arquivará automaticamente os itens de trabalho que foram concluídos ou cancelados.",
        duration: "Arquivar automaticamente itens de trabalho que estão fechados por",
      },
      "auto-close": {
        title: "Fechar automaticamente itens de trabalho",
        description: "O Apollo fechará automaticamente os itens de trabalho que não foram concluídos ou cancelados.",
      ...
      heading: "Automações",
      description: "Configure ações automáticas para agilizar a gestão do projeto e reduzir tarefas manuais.",
    },
    empty_state: {
      labels: {
  ...
  project_cycles: {
    ...
    start_date: "Data de início",
    end_date: "Data de término",
    in_your_timezone: "No seu fuso horário",
    transfer_work_items: "Transferir {count} itens",
    date_range: "Período",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          ...
          comic: {
            title: "Os itens de trabalho são blocos de construção no Apollo.",
            description:
              "Redesenhar a interface do usuário do Apollo, reformular a marca da empresa ou lançar o novo sistema de injeção de combustível são exemplos de itens de trabalho que provavelmente têm subitens de trabalho.",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        title:
          "Escreva uma nota, um documento ou uma base de conhecimento completa. Peça à IA Apollo para ajudá-lo a começar",
        description:
          "As páginas são espaço para registrar pensamentos no Apollo. Anote notas de reunião, formate-as facilmente, incorpore itens de trabalho, organize-os usando uma biblioteca de componentes e mantenha-os todos no contexto do seu projeto. Para facilitar qualquer documento, invoque a IA Apollo com um atalho ou o clique de um botão.",
        primary_button: {
  ...
  self_hosted_maintenance_message: {
    plane_didnt_start_up_this_could_be_because_one_or_more_plane_services_failed_to_start:
      "O Apollo não inicializou. Isso pode ser porque um ou mais serviços do Apollo falharam ao iniciar.",
  ...
  preferences: "Preferências",
  language_and_time: "Idioma e fuso horário",
  timezone_setting: "Fuso horário atual.",
  language_setting: "Escolha o idioma usado na interface.",
  settings_moved_to_preferences: "As configurações de fuso horário e idioma foram movidas para as preferências.",
  go_to_preferences: "Ir para preferências",
  settings_description:
    "Gerencie as preferências da sua conta, do workspace e dos projetos em um só lugar. Alterne entre as abas para configurar.",
  ...
  power_k: {
    contextual_actions: {
      work_item: {
        ...
        add_to_modules: "Adicionar a módulos",
        ...
        copy_id_toast_error: "Ocorreu um erro ao copiar o ID do item.",
        copy_title: "Copiar título",
        copy_title_toast_success: "Título do item copiado para a área de transferência.",
        copy_title_toast_error: "Ocorreu um erro ao copiar o título do item.",
        copy_url: "Copiar URL",
        copy_url_toast_success: "URL do item copiada para a área de transferência.",
        copy_url_toast_error: "Ocorreu um erro ao copiar a URL do item.",
      },
      cycle: {
        ...
        copy_url_toast_error: "Ocorreu um erro ao copiar a URL do ciclo.",
      },
      module: {
        ...
        copy_url_toast_error: "Ocorreu um erro ao copiar a URL do módulo.",
      },
      page: {
        ...
        copy_url_toast_error: "Ocorreu um erro ao copiar a URL da página.",
      },
    },
    creation_actions: {
      create_work_item: "Novo item",
      create_page: "Nova página",
    ...
    navigation_actions: {
      ...
      nav_home: "Ir para o início",
      nav_inbox: "Ir para o inbox",
      nav_your_work: "Ir para seu trabalho",
      nav_account_settings: "Ir para as configurações da conta",
      open_project: "Abrir um projeto",
      nav_projects_list: "Ir para a lista de projetos",
      nav_all_workspace_work_items: "Ir para todos os itens",
      nav_assigned_workspace_work_items: "Ir para itens atribuídos a mim",
      nav_created_workspace_work_items: "Ir para itens criados por mim",
      nav_subscribed_workspace_work_items: "Ir para itens que acompanho",
      nav_workspace_analytics: "Ir para o analytics do workspace",
      nav_workspace_drafts: "Ir para os rascunhos do workspace",
      nav_workspace_archives: "Ir para os arquivados do workspace",
      open_workspace_setting: "Abrir uma configuração do workspace",
      nav_workspace_settings: "Ir para as configurações do workspace",
      nav_project_work_items: "Ir para os itens",
      open_project_cycle: "Abrir um ciclo",
      nav_project_cycles: "Ir para os ciclos",
      open_project_module: "Abrir um módulo",
      nav_project_modules: "Ir para os módulos",
      open_project_view: "Abrir uma visualização do projeto",
      nav_project_views: "Ir para as visualizações do projeto",
      nav_project_pages: "Ir para as páginas",
      nav_project_intake: "Ir para o intake",
      nav_project_archives: "Ir para os arquivados do projeto",
      open_project_setting: "Abrir uma configuração do projeto",
      nav_project_settings: "Ir para as configurações do projeto",
    },
    account_actions: {
      sign_out: "Sair",
      workspace_invites: "Convites de workspace",
    },
    miscellaneous_actions: {
      toggle_app_sidebar: "Alternar a barra lateral",
      ...
      copy_current_page_url_toast_error: "Ocorreu um erro ao copiar a URL da página atual.",
      focus_top_nav_search: "Focar o campo de busca",
    },
    preferences_actions: {
      update_theme: "Alterar o tema da interface",
      update_timezone: "Alterar o fuso horário",
      update_start_of_week: "Alterar o primeiro dia da semana",
      update_language: "Alterar o idioma da interface",
      toast: {
        theme: {
        ...
        timezone: {
          success: "Fuso horário atualizado.",
    ...
    help_actions: {
      open_keyboard_shortcuts: "Abrir os atalhos do teclado",
      open_plane_documentation: "Abrir a documentação do Apollo",
    ...
    page_placeholders: {
      ...
      update_work_item_module: "Adicionar a módulos",
  ...
  customize_navigation: "Personalizar navegação",
  personal: "Pessoal",
  accordion_navigation_control: "Navegação em acordeão na barra lateral",
  horizontal_navigation_bar: "Navegação em abas",
  show_limited_projects_on_sidebar: "Limitar projetos exibidos na barra lateral",
  enter_number_of_projects: "Informe o número de projetos",
  pin: "Fixar",
  unpin: "Desafixar",
} as const;
