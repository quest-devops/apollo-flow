...
// plane website url
export const WEBSITE_URL = process.env.VITE_WEBSITE_URL || "https://apollosolution.com.br";
// support email
export const SUPPORT_EMAIL = process.env.VITE_SUPPORT_EMAIL || "support@apollosolution.com.br";
// marketing links
export const MARKETING_PRICING_PAGE_LINK = "https://apollosolution.com.br";
export const MARKETING_CONTACT_US_PAGE_LINK = "https://apollosolution.com.br";
export const MARKETING_PLANE_ONE_PAGE_LINK = "https://apollosolution.com.br";
