  ...
  function ProfileSettingsLanguageAndTimezonePreferencesList() {
    ...
    const handleTimezoneChange = async (value: string) => {
      try {
        ...
        setToast({
          title: "Erro!",
          message: "Não foi possível atualizar o fuso horário",
    ...
    const handleLanguageChange = async (value: string) => {
      try {
        ...
        setToast({
          title: "Erro!",
          message: "Não foi possível atualizar o idioma",
          type: TOAST_TYPE.ERROR,
        });
      }
    };
      ...
      <div className="flex flex-col gap-y-1">
        ...
        <SettingsControlItem
          ...
          control={
            <CustomSelect
              ...
              label={profile?.language ? getLanguageLabel(profile?.language) : "Selecione um idioma"}
        ...
        <StartOfWeekPreference
          option={{
            ...
            description: "Isso muda a aparência de todos os calendários no app.",
          }}
        />
      </div>
    );
