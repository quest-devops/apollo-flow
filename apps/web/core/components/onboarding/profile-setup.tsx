                ...
                <>
                  <div className="space-y-1">
                    <label className="text-13 font-medium text-tertiary" htmlFor="password">
                      Defina uma senha ({t("common.optional")})
                    </label>
                    <Controller
                      control={control}
                      name="password"
                  ...
                  <div className="space-y-1">
                    ...
                    <Controller
                      ...
                      rules={{
                        ...
                        validate: (value) =>
                          watch("password") ? (value === watch("password") ? true : "As senhas não coincidem") : true,
                      }}
                      render={({ field: { value, onChange, ref } }) => (
                        <div className="relative flex items-center rounded-md">
                          <Input
            ...
            <>
              ...
              <div className="space-y-1">
                <label
                  ...
                  htmlFor="use_case"
                >
                  Qual é a sua área de especialidade? Escolha uma ou mais.
                </label>
                <Controller
                  control={control}
                  name="use_case"
