...
export const WorkspaceCreateStep = observer(function WorkspaceCreateStep({
    ...
    return (
      <div className="flex flex-col gap-10">
        <span className="text-center text-14 text-tertiary">
          Parece que você não tem nenhum convite para um workspace, e o administrador da instância restringiu a criação
          de novos workspaces. Peça a um proprietário ou administrador de workspace que convide você primeiro e volte a
          esta tela para entrar.
        </span>
      </div>
    );
  }
  return (
    ...
    >
      <CommonOnboardingHeader title="Crie seu workspace" description="Todo o seu trabalho — unificado." />
