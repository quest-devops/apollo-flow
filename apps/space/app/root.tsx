...
const APP_TITLE = "Apollo Publish | Compartilhe seus quadros publicamente com um clique";
const APP_DESCRIPTION = "Apollo Publish é a ferramenta da Apollo Solution para publicar quadros e coletar feedback";
