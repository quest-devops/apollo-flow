...
from .app.apollo import ApolloCallbackEndpoint, ApolloOauthInitiateEndpoint
...
from .space.apollo import ApolloCallbackSpaceEndpoint, ApolloOauthInitiateSpaceEndpoint
