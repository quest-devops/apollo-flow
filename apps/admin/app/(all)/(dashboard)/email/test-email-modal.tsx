                ...
                <div className="pt-6 pb-2">
                  ...
                  {sendEmailStep === ESendEmailSteps.SUCCESS && (
                    <div className="flex flex-col gap-y-4 text-13">
                      <p>
                        Enviamos o e-mail de teste para {receiverEmail}. Se não encontrá-lo, verifique a pasta de spam.
                      </p>
                      <p>
                        Se ainda assim não encontrar, revise a configuração de SMTP e envie um novo e-mail de teste.
                      </p>
                    </div>
                  )}
                  ...
                  <div className="mt-5 flex items-center justify-end gap-2">
                    ...
                    {sendEmailStep === ESendEmailSteps.SEND_EMAIL && (
                      <Button variant="primary" size="lg" loading={isLoading} onClick={handleSubmit} tabIndex={3}>
                        {isLoading ? "Enviando e-mail" : "Enviar e-mail"}
                      </Button>
                    )}
                  </div>
                </div>
